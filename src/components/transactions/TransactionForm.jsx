          ...
          <div>
            ...
            <p className="text-xs text-slate-500 font-medium mt-0.5">
              {editingTransaction
                ...
                : "Add a new record to your dashboard"}
            </p>
          </div>
          <button
            onClick={onClose}
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                className={`w-full pl-9 pr-4 py-3.5 rounded-2xl border bg-slate-50 text-slate-900 text-2xl font-bold tracking-tight focus:outline-none 
